...
class message (object):
    ...
    A driver may derive this or this as it is
    '''
...
class window (object):
    ...
    def refresh (self, row, col, width):
        ...
        Normally you want to call write() with text to cover all the given
        strip.
